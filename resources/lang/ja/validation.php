...
return [
    ...
    */
    ...
    'alpha'           => ':attributeには半角英字のみからなる文字列を指定してください。',
    'alpha_dash'      => ':attributeには半角英数字・ハイフン・アンダースコアのみからなる文字列を指定してください。',
    'alpha_num'       => ':attributeには半角英数字のみからなる文字列を指定してください。',
    'array'           => ':attributeには配列を指定してください。',
    'before'          => ':attributeには:date以前の日付を指定してください。',
    'before_or_equal' => ':attributeには:dateかそれ以前の日付を指定してください。',
    'between'         => [
        'numeric' => ':attributeには:min〜:maxまでの数値を半角で指定してください。',
    ...
    'digits'         => ':attributeには:digits桁の数値を半角で指定してください。',
    'digits_between' => ':attributeには:min〜:max桁の数値を半角で指定してください。',
    ...
    'gt'             => [
        'numeric' => ':attributeには:valueを超える数値を半角で指定してください',
        'file'    => ':attributeには:value KBを超えるファイルを指定してください。',
        'string'  => ':attributeには:value文字を超える文字列を指定してください。',
        'array'   => ':attributeには:value個を超える要素を持つ配列を指定してください。',
    ],
    'gte' => [
        'numeric' => ':attributeには:value以上の数値を半角で指定してください',
    ...
    'lt'       => [
        'numeric' => ':attributeには:value未満の数値を半角で指定してください',
    ...
    'min'       => [
        'numeric' => ':attributeには:min以上の数値を半角で指定してください。',
    ...
    'numeric'              => ':attributeには数値を半角で指定してください。',
    ...
    */
    ...
    'custom' => [
        'password' => [
            'required_with' => ':attributeが確認用の値と一致しません。',
        ],
        'email' => [
            'required_with' => ':attributeが確認用の値と一致しません。',
        ],
